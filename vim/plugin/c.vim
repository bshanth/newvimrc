...
" C data types
syn keyword       c89Type           int long short char void signed unsigned float double bool inline
...
"  syn match       cAssignOperator display "|="
  ...
  syn cluster     cOperator         add=cMathOperator,cPointerOperator,cLogicalOperator,cBinaryOperator,cLogicalOperatorError,cBinaryOperatorError,cAssignOperator
endif
if !exists("c_c_vim_compatible") || exists("c_gnu")
...
if !exists("c_no_ansi") || exists("c_ansi_typedefs")
  syn keyword     c89Typedef        size_t wchar_t ptrdiff_t sig_atomic_t fpos_t div_t ldiv_t u_char
...
if !exists("c_no_ansi") || exists("c_ansi_constants")
  ...
  if !exists("c_c_vim_compatible") || exists("c_gnu")
    ...
    syn keyword   cGNUConstant      __GNUC__ __PRETTY_FUNCTION__
...
"vim-mark
syn match cUserLabelTypeDef   display "[a-z|_|0-9]\+_t[ |*|;]"
hi def link cUserLabelTypeDef  SpecialKey

syn match cUserMacro  display "[A-Z|_|0-9]\+"
syn cluster   cParenContents      add=cUserMacro
hi def link cUserMacro cMacro
...
"vim-mark
syn cluster   cParenContents      add=cUserLabelTypeDef
...
"hi cComment                         term=standout cterm=bold ctermfg=0 guifg=tan guibg=grey30
