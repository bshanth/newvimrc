...
"    call Decho("g:netrw_keepdir=".g:netrw_keepdir.": getcwd<".getcwd()."> acd=".&acd)
    ...
    if &l:acd
"     call Decho("exe keepjumps lcd ".fnameescape(curdir))  "
     try
...
"   call Decho("executing: !".g:netrw_rcp_cmd." ".s:netrw_rcpmode." ".shellescape(uid_machine).":".shellescape(b:netrw_fname)." ".shellescape(tmpfile))
   exe s:netrw_silentxfer."!".g:netrw_rcp_cmd." ".s:netrw_rcpmode." ".shellescape(uid_machine).":".shellescape(b:netrw_fname)." ".shellescape(tmpfile)
...
"      call Decho("filter input: ".getline('.'))
     ...
     exe "put ='".'get \"'.fnameescape(netrw_fname).'\" '.fnameescape(tmpfile)."'"
"     call Decho("filter input: ".getline('.'))
     if exists("g:netrw_port") && g:netrw_port != ""
"      call Decho("executing: %!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine)." ".shellescape(g:netrw_port))
      exe s:netrw_silentxfer."%!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine)." ".shellescape(g:netrw_port)
     else
"      call Decho("executing: %!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine))
      exe s:netrw_silentxfer."%!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine)
     endif
...
"    call Decho("read via ftp+mipf (method #3)")
    let netrw_fname= fnameescape(b:netrw_fname)
    call s:SaveBufVars()|new|call s:RestoreBufVars()
    setlocal ff=unix
    if exists("g:netrw_port") && g:netrw_port != ""
...
"    call Decho("exe s:netrw_silentxfer.!".g:netrw_scp_cmd.useport." ".shellescape(g:netrw_machine).":".shellescape(b:netrw_fname)." ".shellescape(tmpfile))
    exe s:netrw_silentxfer."!".g:netrw_scp_cmd.useport." ".shellescape(g:netrw_machine).":".shellescape(b:netrw_fname)." ".shellescape(tmpfile)
    let result           = s:NetrwGetFile(readcmd, tmpfile, b:netrw_method)
    let b:netrw_lastfile = choice
...
"KH    let netrw_fname= fnameescape(b:netrw_fname)
"KH:
    let netrw_fname= b:netrw_fname
...
"    call Decho("read via rsync (method #7)")
    let netrw_fname= fnameescape(b:netrw_fname)
"    call Decho("exe ".s:netrw_silentxfer."!".g:netrw_rsync_cmd." ".shellescape(g:netrw_machine).":".shellescape(netrw_fname)." ".shellescape(tmpfile))
    exe s:netrw_silentxfer."!".g:netrw_rsync_cmd." ".shellescape(g:netrw_machine).":".shellescape(netrw_fname)." ".shellescape(tmpfile)
    let result		 = s:NetrwGetFile(readcmd,tmpfile, b:netrw_method)
    let b:netrw_lastfile = choice
...
"     call Decho("exe ".s:netrw_silentxfer."!".g:netrw_fetch_cmd." ".shellescape(tmpfile)." ".shellescape(netrw_option)."://".shellescape(g:netrw_uid).':'.shellescape(s:netrw_passwd).'@'.shellescape(g:netrw_machine)."/".shellescape(netrw_fname))
     exe s:netrw_silentxfer."!".g:netrw_fetch_cmd." ".shellescape(tmpfile)." ".shellescape(netrw_option)."://".shellescape(g:netrw_uid).':'.shellescape(s:netrw_passwd).'@'.shellescape(g:netrw_machine)."/".shellescape(netrw_fname)
    else
"     call Decho("exe ".s:netrw_silentxfer."!".g:netrw_fetch_cmd." ".shellescape(tmpfile)." ".shellescape(netrw_option)."://".shellescape(g:netrw_machine)."/".shellescape(netrw_fname))
     exe s:netrw_silentxfer."!".g:netrw_fetch_cmd." ".shellescape(tmpfile)." ".shellescape(netrw_option)."://".shellescape(g:netrw_machine)."/".shellescape(netrw_fname)
    endif
...
"    call Decho("read via sftp (method #9)")
    let netrw_fname= fnameescape(b:netrw_fname)
"    call Decho("exe ".s:netrw_silentxfer."!".g:netrw_sftp_cmd." ".shellescape(g:netrw_machine).":".shellescape(netrw_fname)." ".shellescape(tmpfile))
    exe s:netrw_silentxfer."!".g:netrw_sftp_cmd." ".shellescape(g:netrw_machine).":".shellescape(netrw_fname)." ".shellescape(tmpfile)
    let result		= s:NetrwGetFile(readcmd, tmpfile, b:netrw_method)
    let b:netrw_lastfile = choice
...
"   call Decho("(write entire file) silent exe w! ".v:cmdarg." ".fnameescape(tmpfile))
   silent exe "w! ".v:cmdarg." ".fnameescape(tmpfile)
  elseif g:netrw_cygwin
   " write (selected portion of) file to temporary
   let cygtmpfile= fnameescape(substitute(tmpfile,'/cygdrive/\(.\)','\1:',''))
"   call Decho("(write selected portion) silent exe ".a:firstline."," . a:lastline . "w! ".v:cmdarg." ".cygtmpfile)
   ...
   " write (selected portion of) file to temporary
"   call Decho("(write selected portion) silent exe ".a:firstline."," . a:lastline . "w! ".v:cmdarg." ".fnameescape(tmpfile))
   silent exe a:firstline."," . a:lastline . "w! ".v:cmdarg." ".fnameescape(tmpfile)
  endif
...
"    call Decho("write via rcp (method #1)")
    ...
    let netrw_fname= fnameescape(b:netrw_fname)
"    call Decho("executing: !".g:netrw_rcp_cmd." ".s:netrw_rcpmode." ".shellescape(tmpfile)." ".shellescape(uid_machine).":".shellescape(netrw_fname))
    exe s:netrw_silentxfer."!".g:netrw_rcp_cmd." ".s:netrw_rcpmode." ".shellescape(tmpfile)." ".shellescape(uid_machine).":".shellescape(netrw_fname)
    let b:netrw_lastfile = choice
...
"     call Decho("filter input: ".getline('.'))
    ...
    exe "put ='".'put \"'.fnameescape(tmpfile).'\" \"'.fnameescape(netrw_fname).'\"'."'"
"    call Decho("filter input: ".getline('.'))
    if exists("g:netrw_port") && g:netrw_port != ""
"     call Decho("executing: %!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine)." ".shellescape(g:netrw_port))
     exe s:netrw_silentxfer."%!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine)." ".shellescape(g:netrw_port)
...
"    call Decho("exe ".s:netrw_silentxfer."!".g:netrw_scp_cmd.useport." ".shellescape(tmpfile)." ".shellescape(g:netrw_machine).":".shellescape(netrw_fname))
    exe s:netrw_silentxfer."!".g:netrw_scp_cmd.useport." ".shellescape(tmpfile)." ".shellescape(g:netrw_machine).":".shellescape(netrw_fname)
    let b:netrw_lastfile = choice
...
"    call Decho("write via rsync (method #7)")
    let netrw_fname= fnameescape(b:netrw_fname)
"    call Decho("executing: !".g:netrw_rsync_cmd." ".shellescape(tmpfile)." ".shellescape(g:netrw_machine.":".netrw_fname))
    exe s:netrw_silentxfer."!".g:netrw_rsync_cmd." ".shellescape(tmpfile)." ".shellescape(g:netrw_machine.":".netrw_fname)
    let b:netrw_lastfile = choice
...
"    call Decho("filter input: ".getline('.'))
    norm! 1Gdd
"    call Decho("executing: %!".g:netrw_sftp_cmd.' '.shellescape(uid_machine))
    exe s:netrw_silentxfer."%!".g:netrw_sftp_cmd.' '.shellescape(uid_machine)
    bd!
    let b:netrw_lastfile= choice
...
"   call Decho("read file<".a:tfile."> after current line")
   let curline = line(".")
   let lastline= line("$")
"   call Decho("exe<".a:readcmd." ".v:cmdarg." ".fnameescape(a:tfile).">  line#".curline)
   exe a:readcmd." ".v:cmdarg." ".fnameescape(a:tfile)
   let line1= curline + 1
...
"  call Dfunc("s:BrowserMaps(islocal=".a:islocal.") b:netrw_curdir<".b:netrw_curdir.">")
  if a:islocal
   nnoremap <buffer> <silent> <cr>	:call netrw#LocalBrowseCheck(<SID>NetrwBrowseChgDir(1,<SID>NetrwGetWord())) <bar> wincmd p <bar> close<cr>
...
"    call Decho("  reusing buffer#".bufnum."<".((bufnum > 0)? bufname(bufnum) : "")."> using:  b ".bufnum)
   ...
   if bufname("%") == '.'
    exe "silent! keepalt file ".fnameescape(escape(getcwd(),' '))
   endif
   let &ei= eikeep
   if line("$") <= 1
...
"  call Decho("--do netrw settings: make this buffer not-a-file, modifiable, not line-numbered, etc--")
  let fname= expand("%")
  call s:NetrwListSettings(a:islocal)
  exe "keepalt file ".fnameescape(escape(fname,' '))
...
"     call Decho('silent! menu '.g:NetrwMenuPriority.".2.".cnt." ".g:NetrwTopLvlMenu.'Bookmark.'.fnameescape(bmdir).'	:e '.fnameescape(bmdir))
     exe 'silent! menu '.g:NetrwMenuPriority.".2.".cnt." ".g:NetrwTopLvlMenu.'Bookmarks.'.fnameescape(bmdir).'	:e '.fnameescape(bmdir)."\<cr>"
    endif
    let cnt= cnt + 1
   endwhile
...
"     call Decho('silent! menu '.g:NetrwMenuPriority.".3.".priority." ".g:NetrwTopLvlMenu.'History.'.fnameescape(bmdir).'	:e '.fnameescape(bmdir))
     exe 'silent! menu '.g:NetrwMenuPriority.".3.".priority." ".g:NetrwTopLvlMenu.'History.'.fnameescape(bmdir).'	:e '.fnameescape(bmdir)."\<cr>"
    endif
    let first = 0
    let cnt   = ( cnt - 1 ) % g:netrw_dirhistmax
    if cnt < 0
...
"   call Decho("a:remote=".a:remote.": create a local copy of <".a:fname."> as <".fname.">")
   ...
   setlocal bh=delete
"   call Decho("read <".fname.">, now writing: exe w! ".fnameescape(fname))
...
"   call s:System("delete",shellescape(fname))
"  endif
...
"    call Decho("match(g:netrw_list_hide<".g:netrw_list_hide.'> fname<\<'.fname.'\>>)='.match(g:netrw_list_hide,'\<'.fname.'\>')." isk=".&isk)
    if match(g:netrw_list_hide,'\<'.fname.'\>') != -1
     ...
     let g:netrw_list_hide= substitute(g:netrw_list_hide,'..\<'.fnameescape(fname).'\>..','','')
...
"     call Decho("unhide: g:netrw_list_hide<".g:netrw_list_hide.">")
     ...
     if exists("g:netrw_list_hide") && g:netrw_list_hide != ""
      let g:netrw_list_hide= g:netrw_list_hide.',\<'.fnameescape(fname).'\>'
     else
      let g:netrw_list_hide= '\<'.fnameescape(fname).'\>'
     endif
...
"      call Decho("fname<".fname."> is compressed so decompress with <".exe.">")
      ...
      if executable(exe)
       if a:islocal
	call system(exe." ".shellescape(fname))
       else
        call s:RemoteSystem(exe." ".shellescape(fname))
       endif
      else
       call netrw#ErrorMsg(s:WARNING,"unable to apply<".exe."> to file<".fnameescape(fname).">",50)
      endif
      break
     endif
    endfor
    ...
    elseif a:islocal
     ...
     call system(g:netrw_compress." ".s:ComposePath(shellescape(b:netrw_curdir),shellescape(fname)))
    else
     " fname not a compressed file, so compress it
...
"   call Decho("copy from remote to remote")
   ...
   if isdirectory(tmpdir)
    ...
    if getcwd() == tmpdir
     ...
     exe "keepjumps lcd ".fnameescape(curdir)
     exe "silent !".g:netrw_local_rmdir." ".shellescape(tmpdir)
    else
     exe "keepjumps lcd ".fnameescape(curdir)
    endif
   endif
...
"     let flist= flist." ".s:ComposePath(curdir,fname)
     let flist= flist." ".fnameescape(fname)
    endfor
   else
...
"   call Decho("cmd<".cmd.">")
   ...
   for fname in s:netrwmarkfilelist_{curbufnr}
    if a:islocal
     if g:netrw_keepdir
      let fname= s:ComposePath(shellescape(curdir(,shellescape(fname))
     endif
    else
     let fname= shellescape(b:netrw_curdir).shellescape(fname)
    endif
    if cmd =~ '%'
...
"    call Decho("exe silent e ".fnameescape(escape(fname,' ')))
    exe "silent e ".fnameescape(escape(fname,' '))
"    call Decho("hardcopy")
    hardcopy
    q
   endfor
...
"    call Decho("exe so ".fnameescape(escape(fname,' ')))
    exe "so ".fnameescape(escape(fname,' '))
   endfor
   2match none
  endif
...
"    call Decho("obtain via scp (method#4)")
    ...
    let filelist= join(map(copy(fnamelist),'shellescape(g:netrw_machine).":".shellescape(path.v:val)'))
...
"    call Decho("exe ".s:netrw_silentxfer."!".g:netrw_scp_cmd.useport." ".args." ".shellescape(machine).":".shellescape(tgt))
    exe s:netrw_silentxfer."!".g:netrw_scp_cmd.useport." ".args." ".shellescape(machine).":".shellescape(tgt)
...
"      call Decho("filter input: ".getline('$'))
     ...
     if exists("g:netrw_port") && g:netrw_port != ""
"      call Decho("executing: ".s:netrw_silentxfer."%!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine)." ".shellescape(g:netrw_port))
      exe s:netrw_silentxfer."%!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine)." ".shellescape(g:netrw_port)
     else
"      call Decho("filter input window#".winnr())
"      call Decho("executing: ".s:netrw_silentxfer."%!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine))
      exe s:netrw_silentxfer."%!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine)
     endif
     " If the result of the ftp operation isn't blank, show an error message (tnx to Doug Claar)
...
"  call Dfunc("NetrwPreview(path<".a:path.">)")
  ...
  if has("quickfix")
   ...
   elseif !exists("g:netrw_quiet")
    call netrw#ErrorMsg(s:WARNING,"sorry, cannot preview a directory such as <".fnameescape(a:path).">",38)
   endif
  elseif !exists("g:netrw_quiet")
...
"    call Decho("1: exe silent r! ".listcmd.fnameescape(s:path))
    exe "silent r! ".listcmd.fnameescape(s:path)
...
"     call Decho("3: exe silent r! ".listcmd.' "'.fnameescape(s:path).'"')
     exe "silent r! ".listcmd.' "'.fnameescape(s:path).'"'
"     call Decho("listcmd<".listcmd."> path<".fnameescape(s:path).">")
    endif
   endif
...
"   exe "keepjumps ".w:netrw_bannercnt.',$g/^./call Decho("ftp#".line(".").": ".getline("."))'
   if exists("g:netrw_port") && g:netrw_port != ""
"    call Decho("exe ".s:netrw_silentxfer.w:netrw_bannercnt.",$!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine)." ".shellescape(g:netrw_port))
    exe s:netrw_silentxfer." keepjumps ".w:netrw_bannercnt.",$!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine)." ".shellescape(g:netrw_port)
   else
"    call Decho("exe ".s:netrw_silentxfer.w:netrw_bannercnt.",$!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine))
    exe s:netrw_silentxfer." keepjumps ".w:netrw_bannercnt.",$!".g:netrw_ftp_cmd." -i ".shellescape(g:netrw_machine)
   endif
...
"     call Decho("system(rename_cmd".' "'.shellescape(oldname," ").'" "'.shellescape(newname).'"')
...
"    call Decho("exe keepjumps put ='".ft.'/'.fnameescape(filename)."'")
...
"    call Decho("exe keepjumps put ='".fsz.'/'.fnameescape(filename)."'")
    let fszpfile= fsz.'/'.pfile
    keepjumps silent! put =fszpfile

   else
    " sort by name
"    call Decho("exe keepjumps put ='".fnameescape(pfile)."'")
...
"    call Decho("response: ok<".ok."> (after sub)")
   ...
   if all || ok =~ 'y\%[es]' || ok == ""
    let ret= s:System("delete",fnameescape(rmfile))
"    call Decho("errcode=".v:shell_error." ret=".ret)
   ...
   if all || ok =~ 'y\%[es]' || ok == ""
"    call Decho("1st attempt: system(".g:netrw_local_rmdir.' '.fnameescape(rmfile).')')
    call s:System("system",g:netrw_local_rmdir.' '.fnameescape(rmfile))
"    call Decho("v:shell_error=".v:shell_error)

    if v:shell_error != 0
"     call Decho("2nd attempt to remove directory<".rmfile.">")
     let errcode= s:System("delete", fnameescape(rmfile))
"     call Decho("errcode=".errcode)

     if errcode != 0
      if has("unix")
"       call Decho("3rd attempt to remove directory<".rmfile.">")
       call s:System("system","rm ".fnameescape(rmfile))
       if v:shell_error != 0 && !exists("g:netrw_quiet")
...
"   call Decho("tmpfile<".tmpfile."> : from tempname()")
   ...
   let tmpfile= fnameescape(substitute(tmpfile,'\','/','ge'))
